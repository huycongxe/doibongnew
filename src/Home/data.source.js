...
export const Banner50DataSource = {
  ...
  childWrapper: {
    ...
    children: [
      ...
      {
        name: 'content',
        className: 'banner5-content kluc5isv44-editor_css',
        children: (
          <span>
            <span>
              <p>
                Trang quản lý thông tin đội bóng và cầu thủ tham dự WorldCup
                2022
              </p>
            </span>
          </span>
  ...
  image: {
    className: 'banner5-image kruga5ksk57-editor_css',
    children:
      'https://i.pinimg.com/564x/17/05/e2/1705e29060298a1c03a10dc7bcea77a7.jpg',
  },
};
    ...
    children: [
      {
        ...
        children: {
          ...
          img: {
            ...
            children:
              'https://zpsocial-f40-org.zadn.vn/f1510059852669783037.jpg',
          },
          title: {
            className: 'content8-title',
            children: (
              <span>
                <p>Phạm Thị Huỳnh Như</p>
              </span>
            ),
          },
          content: {
      ...
      },
      {
        ...
        children: {
          ...
          img: {
            className: 'content8-img',
            children:
              'https://f17-zpg.zdn.vn/8866535582542489484/15c7babbc18636d86f97.jpg',
          },
          title: {
            className: 'content8-title',
            children: (
      ...
      },
      {
        ...
        children: {
          ...
          img: {
            className: 'content8-img',
            children:
              'https://zpsocial-f42-org.zadn.vn/370e228f8905645b3d14.jpg',
          },
          title: {
            className: 'content8-title',
            children: (
